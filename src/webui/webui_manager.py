...
class WebuiManager:
    ...
    def init_pr_testing_agent(self) -> None:
        """
        Initialize PR testing agent state
        """
        self.pr_client = None
        self.pr_current_task: Optional[asyncio.Task] = None
        self.pr_test_results: Dict[int, Any] = {}
        self.pr_agent_task_id: Optional[str] = None
